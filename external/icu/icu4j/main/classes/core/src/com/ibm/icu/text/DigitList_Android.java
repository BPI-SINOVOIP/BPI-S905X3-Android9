...
// Android-note: this is a copy of DigitList for Android internal use only (b/68143370).
// See note at top of DecimalFormat_ICU58_Android or b/68143370 for context.
...
//    private static final double LOG10 = Math.log(10.0);
  ...
  public boolean equals(Object obj) {
        if (this == obj)                      // quick check
            return true;
        if (!(obj instanceof DigitList_Android))         // (1) same object?
            return false;
