...
public class VariableTableWithGenericTest extends JDWPMethodVariableTableTestCase {
    /**
     ...
     */
    public void testVariableTableWithGenericTest001() {
        checkMethodVariableTable(true);
    }
}
