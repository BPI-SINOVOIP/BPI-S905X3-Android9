...
class EmojiConstants {
    ...
    // All new emoji characters between Emoji 5.0 and Emoji 11
    // Used by FontCoverageTest on top of ALL_EMOJI
    // ALL_EMOJI is used both by cts.FontCoverageTest and cts.EmojiTest. cts.EmojiTest does
    // verification via Character.isDefined and is behind the latest Unicode Emoji set.
    static final int[] NEW_EMOJI = {
        0x265F,
        0x267E,
        0x1F6F9,
        0x1F94D,
