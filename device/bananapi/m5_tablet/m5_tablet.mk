...
PRODUCT_NAME := m5_tablet
PRODUCT_DEVICE := m5_tablet
PRODUCT_BRAND := bpi
PRODUCT_MODEL := m5_tablet
...
#include device/bananapi/common/tuner/tuner.mk
...
include device/bananapi/common/gpu/dvalin-user-arm64.mk
#####npu ovx service
