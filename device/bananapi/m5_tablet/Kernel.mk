...
TARGET_PREBUILT_KERNEL := device/bananapi/m5_tablet-kernel/Image.gz
LOCAL_DTB := device/bananapi/m5_tablet-kernel/bananapi_m5.dtb
...
$(TARGET_PREBUILT_KERNEL): $(INSTALLED_BOARDDTB_TARGET)
	...
	cp device/bananapi/m5_tablet-kernel/lib/mali.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/bananapi/m5_tablet-kernel/lib/modules/* $(KERNEL_KO_OUT)/
	cp device/bananapi/m5_tablet-kernel/lib/optee_armtz.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/bananapi/m5_tablet-kernel/lib/optee.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/bananapi/m5_tablet-kernel/lib/firmware/video/* $(PRODUCT_OUT)/vendor/lib/firmware/video/
	-cp device/bananapi/m5_tablet-kernel/obj/KERNEL_OBJ/vmlinux $(PRODUCT_OUT)/obj/KERNEL_OBJ/
	...
	cp device/bananapi/m5_tablet-kernel/lib/egl/* $(PRODUCT_OUT)/vendor/lib/egl/
