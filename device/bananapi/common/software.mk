...
PRODUCT_COPY_FILES += \
    device/bananapi/common/android.software.google_atv.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/android.software.google_atv.xml
PRODUCT_COPY_FILES += \
...
PRODUCT_PACKAGE_OVERLAYS += device/bananapi/common/atv_gms_overlay
PRODUCT_PACKAGES += \
    TvProvider \
...
#PRODUCT_PACKAGE_OVERLAYS += device/bananapi/common/aosp_gms_overlay
#PRODUCT_PACKAGES += \
#    QuickSearchBox \
#    Contacts \
#    Calendar \
...
PRODUCT_COPY_FILES += \
	device/bananapi/common/droidlogic.software.netflix.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/droidlogic.software.netflix.xml
