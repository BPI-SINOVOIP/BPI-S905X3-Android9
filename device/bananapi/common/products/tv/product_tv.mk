...
PRODUCT_COPY_FILES += \
    ...
    device/bananapi/common/android.software.leanback.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/android.software.leanback.xml \
...
PRODUCT_COPY_FILES += \
    device/bananapi/common/products/tv/Vendor_1915_Product_0001.idc:$(TARGET_COPY_OUT_VENDOR)/usr/idc/Vendor_1915_Product_0001.idc
...
PRODUCT_COPY_FILES += \
    device/bananapi/common/hdcp_rp22/hdcp_rp22:$(TARGET_COPY_OUT_VENDOR)/bin/hdcp_rp22 \
    device/bananapi/common/hdcp_rp22/firmware/firmware_rprx.le:$(TARGET_COPY_OUT_VENDOR)/etc/firmware/hdcp_rp22/firmware_rprx.le \
    device/bananapi/common/hdcp_rp22/firmware/firmware_rptx.le:$(TARGET_COPY_OUT_VENDOR)/etc/firmware/hdcp_rp22/firmware_rptx.le \
