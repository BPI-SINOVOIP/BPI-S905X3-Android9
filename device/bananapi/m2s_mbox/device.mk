...
PRODUCT_COPY_FILES += \
    ...
    device/bananapi/$(PRODUCT_DIR)/files/remote.tab3:$(TARGET_COPY_OUT_VENDOR)/etc/remote.tab3 \
...
PRODUCT_COPY_FILES += \
    device/bananapi/$(PRODUCT_DIR)/aosp/files/media_codecs.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs.xml
endif
...
PRODUCT_COPY_FILES += \
    ...
    device/bananapi/$(PRODUCT_DIR)/files/remote.tab3:recovery/root/etc/remote.tab3 \
...
PRODUCT_COPY_FILES += \
    device/bananapi/common/products/mbox/Vendor_0001_Product_0001.kl:$(TARGET_COPY_OUT_VENDOR)/usr/keylayout/Vendor_0001_Product_0001.kl \
