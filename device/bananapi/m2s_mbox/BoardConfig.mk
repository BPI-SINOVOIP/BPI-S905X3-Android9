...
TARGET_BOOTLOADER_BOARD_NAME := m2s_mbox
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/bananapi/m2s_mbox/bluetooth
...
HWC_DISPLAY_NUM := 2
HWC_PIPELINE := "dual"
HWC_PRIMARY_FRAMEBUFFER_WIDTH := 720
HWC_PRIMARY_FRAMEBUFFER_HEIGHT := 1280
...
BOARD_OVERLAY_TARGET := bananapi_m2s
...
DEVICE_MANIFEST_FILE := device/bananapi/common/products/mbox/manifest/manifest_aosp.xml
else
DEVICE_MANIFEST_FILE := device/bananapi/common/products/mbox/manifest/manifest_gtvs.xml
endif
