...
TARGET_PREBUILT_KERNEL := device/amlogic/newton-kernel/Image.gz
LOCAL_DTB := device/amlogic/newton-kernel/newton.dtb
...
$(TARGET_PREBUILT_KERNEL): $(INSTALLED_BOARDDTB_TARGET)
	...
	cp device/amlogic/newton-kernel/lib/mali.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/amlogic/newton-kernel/lib/modules/* $(KERNEL_KO_OUT)/
	cp device/amlogic/newton-kernel/lib/optee_armtz.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/amlogic/newton-kernel/lib/optee.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/amlogic/newton-kernel/lib/firmware/video/* $(PRODUCT_OUT)/vendor/lib/firmware/video/
	-cp device/amlogic/newton-kernel/obj/KERNEL_OBJ/vmlinux $(PRODUCT_OUT)/obj/KERNEL_OBJ/
	...
	cp device/amlogic/newton-kernel/lib/egl/* $(PRODUCT_OUT)/vendor/lib/egl/
...
KERNEL_DEVICETREE := sm1_s905x3_ac214
