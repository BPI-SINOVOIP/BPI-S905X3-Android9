...
TARGET_PREBUILT_KERNEL := device/amlogic/g12b_skt-kernel/Image.gz
INSTALLED_BOARDDTB_TARGET := $(PRODUCT_OUT)/dt.img
LOCAL_DTB := device/amlogic/g12b_skt-kernel/g12b_skt.dtb
...
$(TARGET_PREBUILT_KERNEL): $(INSTALLED_BOARDDTB_TARGET)
	...
	cp device/amlogic/g12b_skt-kernel/lib/mali.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/amlogic/g12b_skt-kernel/lib/modules/* $(KERNEL_KO_OUT)/
	cp device/amlogic/g12b_skt-kernel/lib/optee_armtz.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/amlogic/g12b_skt-kernel/lib/optee.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/amlogic/g12b_skt-kernel/lib/firmware/video/* $(PRODUCT_OUT)/vendor/lib/firmware/video/
	-cp device/amlogic/g12b_skt-kernel/obj/KERNEL_OBJ/vmlinux $(PRODUCT_OUT)/obj/KERNEL_OBJ/
	...
	cp device/amlogic/g12b_skt-kernel/lib/egl/* $(PRODUCT_OUT)/vendor/lib/egl/
...
KERNEL_DEVICETREE := g12b_a311d_skt g12b_a311d_skt_a
