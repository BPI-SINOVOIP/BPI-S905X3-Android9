...
TARGET_PREBUILT_KERNEL := device/amlogic/dalton-kernel/Image.gz
LOCAL_DTB := device/amlogic/dalton/dalton.dtb
...
$(TARGET_PREBUILT_KERNEL): $(INSTALLED_BOARDDTB_TARGET)
	...
	cp device/amlogic/dalton-kernel/lib/mali.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/amlogic/dalton-kernel/lib/modules/* $(KERNEL_KO_OUT)/
	cp device/amlogic/dalton-kernel/tdk/* $(PRODUCT_OUT)/obj/lib/
	cp device/amlogic/dalton-kernel/tdk/* $(PRODUCT_OUT)/vendor/lib/
	-cp device/amlogic/dalton-kernel/lib/optee_armtz.ko $(PRODUCT_OUT)/vendor/lib/
	-cp device/amlogic/dalton-kernel/lib/optee.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/amlogic/dalton-kernel/tdk/* $(PRODUCT_OUT)/recovery/root/boot/
	-cp device/amlogic/dalton-kernel/obj/KERNEL_OBJ/vmlinux $(PRODUCT_OUT)/obj/KERNEL_OBJ/
	...
	cp device/amlogic/dalton-kernel/lib/egl/* $(PRODUCT_OUT)/vendor/lib/egl/
	cp device/amlogic/dalton-kernel/lib64/egl/* $(PRODUCT_OUT)/vendor/lib64/egl/
...
KERNEL_DEVICETREE := tm2_t962e2_ab311
