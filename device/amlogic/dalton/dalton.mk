...
PRODUCT_COPY_FILES += \
        device/amlogic/dalton/files/sadConfig.xml:$(TARGET_COPY_OUT_VENDOR)/etc/sadConfig.xml

PRODUCT_NAME := dalton
PRODUCT_DEVICE := dalton
PRODUCT_BRAND := Droidlogic
PRODUCT_MODEL := dalton
...
PRODUCT_AML_SECUREBOOT_RSAKEY_DIR := ./bootloader/uboot-repo/bl33/board/amlogic/tm2_t962e2_ab311_v1/aml-key
PRODUCT_AML_SECUREBOOT_AESKEY_DIR := ./bootloader/uboot-repo/bl33/board/amlogic/tm2_t962e2_ab311_v1/aml-key
...
PRODUCT_AML_SECUREBOOT_USERKEY := ./bootloader/uboot-repo/bl33/board/amlogic/tm2_t962e2_ab311_v1/aml-user-key.sig
