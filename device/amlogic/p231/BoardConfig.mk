...
TARGET_BOOTLOADER_BOARD_NAME := p231
...
ifneq ($(TARGET_BUILD_GOOGLE_ATV), true)
  ifneq ($(TARGET_BUILD_LIVETV), true)
    ...
    DEVICE_MANIFEST_FILE := device/amlogic/common/products/mbox/manifest/manifest_p231_aosp_livetv.xml
  endif
else
  ifneq ($(TARGET_BUILD_LIVETV), true)
    DEVICE_MANIFEST_FILE := device/amlogic/common/products/mbox/manifest/manifest_gtvs.xml
  else
    DEVICE_MANIFEST_FILE := device/amlogic/common/products/mbox/manifest/manifest_gtvs_livetv.xml
  endif
endif
