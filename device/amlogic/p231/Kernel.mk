...
TARGET_PREBUILT_KERNEL := device/amlogic/p231-kernel/Image.gz
LOCAL_DTB := device/amlogic/p231-kernel/p231.dtb
...
$(TARGET_PREBUILT_KERNEL): $(INSTALLED_BOARDDTB_TARGET)
	...
	cp device/amlogic/p231-kernel/lib/mali.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/amlogic/p231-kernel/lib/modules/* $(KERNEL_KO_OUT)/
	cp device/amlogic/p231-kernel/tdk/* $(PRODUCT_OUT)/obj/lib/
	cp device/amlogic/p231-kernel/tdk/* $(PRODUCT_OUT)/vendor/lib/
	cp device/amlogic/p231-kernel/tdk/* $(PRODUCT_OUT)/recovery/root/boot/
	-cp device/amlogic/p231-kernel/lib/optee_armtz.ko $(PRODUCT_OUT)/vendor/lib/
	-cp device/amlogic/p231-kernel/lib/optee.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/amlogic/p231-kernel/lib/firmware/video/* $(PRODUCT_OUT)/vendor/lib/firmware/video/
	-cp device/amlogic/p231-kernel/obj/KERNEL_OBJ/vmlinux $(PRODUCT_OUT)/obj/KERNEL_OBJ/
	...
	cp device/amlogic/p231-kernel/lib/egl/* $(PRODUCT_OUT)/vendor/lib/egl/
	cp device/amlogic/p231-kernel/lib64/egl/* $(PRODUCT_OUT)/vendor/lib64/egl/
