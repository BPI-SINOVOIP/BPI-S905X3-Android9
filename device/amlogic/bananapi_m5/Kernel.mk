...
TARGET_PREBUILT_KERNEL := device/amlogic/bananapi_m5-kernel/Image.gz
LOCAL_DTB := device/amlogic/bananapi_m5-kernel/bananapi_m5.dtb
...
$(TARGET_PREBUILT_KERNEL): $(INSTALLED_BOARDDTB_TARGET)
	...
	cp device/amlogic/bananapi_m5-kernel/lib/mali.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/amlogic/bananapi_m5-kernel/lib/modules/* $(KERNEL_KO_OUT)/
	cp device/amlogic/bananapi_m5-kernel/lib/optee_armtz.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/amlogic/bananapi_m5-kernel/lib/optee.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/amlogic/bananapi_m5-kernel/lib/firmware/video/* $(PRODUCT_OUT)/vendor/lib/firmware/video/
	-cp device/amlogic/bananapi_m5-kernel/obj/KERNEL_OBJ/vmlinux $(PRODUCT_OUT)/obj/KERNEL_OBJ/
	...
	cp device/amlogic/bananapi_m5-kernel/lib/egl/* $(PRODUCT_OUT)/vendor/lib/egl/
...
KERNEL_DEVICETREE := sm1_s905x3_bananapi_m5
