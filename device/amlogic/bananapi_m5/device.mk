...
PRODUCT_COPY_FILES += \
    ...
    device/amlogic/$(PRODUCT_DIR)/files/audio_policy_configuration_dolby_ms12.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration_dolby_ms12.xml
else
PRODUCT_COPY_FILES += \
...
PRODUCT_COPY_FILES += \
    ...
    device/amlogic/$(PRODUCT_DIR)/files/Vendor_0001_Product_0001.kl:$(TARGET_COPY_OUT_VENDOR)/usr/keylayout/Vendor_0001_Product_0001.kl \
