...
# marconi ddr 1g config file
PRODUCT_COPY_FILES += \
    device/amlogic/$(PRODUCT_DIR)/files/mem_mode/mem_1g_ro.prop:$(TARGET_COPY_OUT_VENDOR)/etc/mem_1g_ro.prop
...
ifeq ($(KERNEL_A32_SUPPORT), true)
PRODUCT_COPY_FILES += \
    device/amlogic/$(PRODUCT_DIR)/files/speech.ko:$(PRODUCT_OUT)/obj/lib_vendor/speech.ko
else
PRODUCT_COPY_FILES += \
    device/amlogic/$(PRODUCT_DIR)/files/speech64.ko:$(PRODUCT_OUT)/obj/lib_vendor/speech.ko
endif

PRODUCT_AAPT_CONFIG := xlarge hdpi xhdpi tvdpi
PRODUCT_AAPT_PREF_CONFIG := hdpi

PRODUCT_CHARACTERISTICS := marconi,nosdcard
ifneq ($(TARGET_BUILD_GOOGLE_ATV), true)
