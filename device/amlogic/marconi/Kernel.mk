...
TARGET_PREBUILT_KERNEL := device/amlogic/marconi-kernel/Image.gz
LOCAL_DTB := device/amlogic/marconi-kernel/marconi.dtb
...
$(TARGET_PREBUILT_KERNEL): $(INSTALLED_BOARDDTB_TARGET)
	...
	cp device/amlogic/marconi-kernel/lib/mali.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/amlogic/marconi-kernel/lib/modules/* $(KERNEL_KO_OUT)/
	cp device/amlogic/marconi-kernel/tdk/* $(PRODUCT_OUT)/obj/lib/
	cp device/amlogic/marconi-kernel/tdk/* $(PRODUCT_OUT)/vendor/lib/
	-cp device/amlogic/marconi-kernel/lib/optee_armtz.ko $(PRODUCT_OUT)/vendor/lib/
	-cp device/amlogic/marconi-kernel/lib/optee.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/amlogic/marconi-kernel/tdk/* $(PRODUCT_OUT)/recovery/root/boot/
	-cp device/amlogic/marconi-kernel/obj/KERNEL_OBJ/vmlinux $(PRODUCT_OUT)/obj/KERNEL_OBJ/
	...
	cp device/amlogic/marconi-kernel/lib/egl/* $(PRODUCT_OUT)/vendor/lib/egl/
	cp device/amlogic/marconi-kernel/lib64/egl/* $(PRODUCT_OUT)/vendor/lib64/egl/
...
KERNEL_DEVICETREE := tl1_t962x2_x301_1g tl1_t962x2_x301_2g
