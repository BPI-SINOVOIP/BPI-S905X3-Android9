...
TARGET_PREBUILT_KERNEL := device/amlogic/hertz-kernel/Image.gz
LOCAL_DTB := device/amlogic/hertz-kernel/hertz.dtb
...
$(TARGET_PREBUILT_KERNEL): $(INSTALLED_BOARDDTB_TARGET)
	...
	cp device/amlogic/hertz-kernel/lib/mali.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/amlogic/hertz-kernel/lib/modules/* $(KERNEL_KO_OUT)/
	cp device/amlogic/hertz-kernel/lib/optee_armtz.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/amlogic/hertz-kernel/lib/optee.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/amlogic/hertz-kernel/lib/firmware/video/* $(PRODUCT_OUT)/vendor/lib/firmware/video/
	-cp device/amlogic/hertz-kernel/obj/KERNEL_OBJ/vmlinux $(PRODUCT_OUT)/obj/KERNEL_OBJ/
	...
	cp device/amlogic/hertz-kernel/lib/egl/* $(PRODUCT_OUT)/vendor/lib/egl/
...
-include device/amlogic/common/gpu/t82x-kernel.mk
