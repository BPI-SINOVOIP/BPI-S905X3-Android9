...
#
#########################################################################
BUILD_WITH_SOFT_AV1_DECODER := true

PRODUCT_PROPERTY_OVERRIDES += \
        ro.hdmi.device_type=0

PRODUCT_NAME := t962x3_ab301
PRODUCT_DEVICE := t962x3_ab301
PRODUCT_BRAND := Droidlogic
PRODUCT_MODEL := t962x3_ab301
...
PRODUCT_AML_SECUREBOOT_RSAKEY_DIR := ./bootloader/uboot-repo/bl33/board/amlogic/tm2_t962x3_ab301_v1/aml-key
PRODUCT_AML_SECUREBOOT_AESKEY_DIR := ./bootloader/uboot-repo/bl33/board/amlogic/tm2_t962x3_ab301_v1/aml-key
...
PRODUCT_AML_SECUREBOOT_USERKEY := ./bootloader/uboot-repo/bl33/board/amlogic/tm2_t962x3_ab301_v1/aml-user-key.sig
PRODUCT_AML_SECUREBOOT_SIGNTOOL := ./bootloader/uboot-repo/fip/tm2/aml_encrypt_tm2
