...
PRODUCT_COPY_FILES += \
        device/amlogic/t962e2_skt/files/sadConfig.xml:$(TARGET_COPY_OUT_VENDOR)/etc/sadConfig.xml

PRODUCT_NAME := t962e2_skt
PRODUCT_DEVICE := t962e2_skt
PRODUCT_BRAND := Droidlogic
PRODUCT_MODEL := t962e2_skt
...
PRODUCT_AML_SECUREBOOT_RSAKEY_DIR := ./bootloader/uboot-repo/bl33/board/amlogic/tl1_x301_v1/aml-key
PRODUCT_AML_SECUREBOOT_AESKEY_DIR := ./bootloader/uboot-repo/bl33/board/amlogic/tl1_x301_v1/aml-key
...
PRODUCT_AML_SECUREBOOT_USERKEY := ./bootloader/uboot-repo/bl33/board/amlogic/tl1_x301_v1/aml-user-key.sig
