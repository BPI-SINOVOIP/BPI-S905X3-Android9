...
TARGET_PREBUILT_KERNEL := device/amlogic/s905y2_skt-kernel/Image.gz
LOCAL_DTB := device/amlogic/s905y2_skt-kernel/s905y2_skt.dtb
...
$(TARGET_PREBUILT_KERNEL): $(INSTALLED_BOARDDTB_TARGET)
	...
	cp device/amlogic/s905y2_skt-kernel/lib/mali.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/amlogic/s905y2_skt-kernel/lib/modules/* $(KERNEL_KO_OUT)/
	cp device/amlogic/s905y2_skt-kernel/lib/optee_armtz.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/amlogic/s905y2_skt-kernel/lib/optee.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/amlogic/s905y2_skt-kernel/lib/firmware/video/* $(PRODUCT_OUT)/vendor/lib/firmware/video/
	-cp device/amlogic/s905y2_skt-kernel/obj/KERNEL_OBJ/vmlinux $(PRODUCT_OUT)/obj/KERNEL_OBJ/
	...
	cp device/amlogic/s905y2_skt-kernel/lib/egl/* $(PRODUCT_OUT)/vendor/lib/egl/
...
KERNEL_DEVICETREE := g12a_s905y2_u220
