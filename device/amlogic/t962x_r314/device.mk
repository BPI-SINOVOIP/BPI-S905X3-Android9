...
PRODUCT_COPY_FILES += \
    ...
    device/amlogic/$(PRODUCT_DIR)/files/tv/cimax+_usbdvb_1105.bin:$(PRODUCT_OUT)/vendor/firmware/cimax+_usbdvb.bin \
    device/amlogic/$(PRODUCT_DIR)/files/tv/cimax+usb.cfg:$(PRODUCT_OUT)/vendor/firmware/cimax+usb.cfg \
