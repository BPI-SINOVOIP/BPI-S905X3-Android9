...
PRODUCT_NAME := anning
PRODUCT_DEVICE := anning
PRODUCT_BRAND := Droidlogic
PRODUCT_MODEL := anning
...
PRODUCT_AML_SECUREBOOT_RSAKEY_DIR := ./bootloader/uboot-repo/bl33/board/amlogic/gxl_p244_v1/aml-key
PRODUCT_AML_SECUREBOOT_AESKEY_DIR := ./bootloader/uboot-repo/bl33/board/amlogic/gxl_p244_v1/aml-key
...
PRODUCT_AML_SECUREBOOT_USERKEY := ./bootloader/uboot-repo/bl33/board/amlogic/gxl_p244_v1/aml-user-key.sig
