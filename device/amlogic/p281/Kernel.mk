...
TARGET_PREBUILT_KERNEL := device/amlogic/p281-kernel/Image.gz
LOCAL_DTB := device/amlogic/p281-kernel/p281.dtb
...
$(TARGET_PREBUILT_KERNEL): $(INSTALLED_BOARDDTB_TARGET)
	...
	cp device/amlogic/p281-kernel/lib/mali.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/amlogic/p281-kernel/lib/modules/* $(KERNEL_KO_OUT)/
	cp device/amlogic/p281-kernel/lib/optee_armtz.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/amlogic/p281-kernel/lib/optee.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/amlogic/p281-kernel/lib/firmware/video/* $(PRODUCT_OUT)/vendor/lib/firmware/video/
	-cp device/amlogic/p281-kernel/obj/KERNEL_OBJ/vmlinux $(PRODUCT_OUT)/obj/KERNEL_OBJ/
	...
	cp device/amlogic/p281-kernel/lib/egl/* $(PRODUCT_OUT)/vendor/lib/egl/
