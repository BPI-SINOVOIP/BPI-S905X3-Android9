...
public class AudioAdMixLevelFragment extends SideFragment {
    private static final String TAG = "AudioAdMixLevelFragment";
    ...
    protected String getTitle() {
        return getString(R.string.channel_audio_ad_mix_level);
    }
    ...
    protected List<Item> getItemList() {
        ...
        items.add(new SingleSeekBarItem(TAG, mChannelSettingsManager.getADMixStatus()));
        return items;
    }
    ...
    private class SingleSeekBarItem extends SingleStepSeekBarItem {
        ...
        protected void onProgressChanged(SeekBar seekBar, int progress) {
            ...
            mChannelSettingsManager.setADMix(progress - mChannelSettingsManager.getADMixStatus());
