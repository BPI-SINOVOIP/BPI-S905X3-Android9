...
#define RETRY_MAX 3
#define EVENT_ONSUBTITLEDATA_CALLBACK 30
#define EVENT_ONSUBTITLEAVAILABLE_CALLBACK 31
...
private:
    class SubtitleServerHidlCallback : public ISubtitleServerCallback {
    public:
        SubtitleServerHidlCallback(SubtitleServerHidlClient *client): subtitleserverClient(client) {};
        Return<void> notifyCallback(const SubtitleHidlParcel& parcel) override;
