...
OMX_PATH_32_CTC := $(TARGET_OUT)/lib/
...
include $(CLEAR_VARS)
LOCAL_MODULE := libHwAudio_dcvdec.ctc
LOCAL_NANE_LIB:= libHwAudio_dcvdec
LOCAL_MULTILIB := both
LOCAL_MODULE_SUFFIX := .so
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_PATH_32 := $(OMX_PATH_32_CTC)
LOCAL_SRC_FILES_arm := lib/$(LOCAL_NANE_LIB)$(LOCAL_MODULE_SUFFIX)
LOCAL_SRC_FILES_arm64 := lib64/$(LOCAL_MODULE)$(LOCAL_MODULE_SUFFIX)
include $(BUILD_PREBUILT)
