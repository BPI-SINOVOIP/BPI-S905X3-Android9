...
$(my_target_output): \
    PRIVATE_TESTS := $(my_tests)
$(my_target_output): \
    PRIVATE_JARS := $(my_jars)
$(my_target_output): \
    PRIVATE_JAVA_ARGS := $(my_java_args)
$(my_target_output): \
    PRIVATE_ROBOLECTRIC_PATH := $(my_robolectric_path)
$(my_target_output): \
    PRIVATE_ROBOLECTRIC_SCRIPT_PATH := $(my_robolectric_script_path)
$(my_target_output): \
    PRIVATE_TARGET_MESSAGE := $(my_target_message)
$(my_target_output): \
    PRIVATE_TARGET_OUTPUT := $(my_target_output)
$(my_target_output): \
