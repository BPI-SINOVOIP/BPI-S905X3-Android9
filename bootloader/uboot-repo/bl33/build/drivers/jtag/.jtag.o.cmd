cmd_drivers/jtag/jtag.o := aarch64-none-elf-gcc -Wp,-MD,drivers/jtag/.jtag.o.d  -nostdinc -isystem /opt/gcc-linaro-aarch64-none-elf-4.8-2013.11_linux/bin/../lib/gcc/aarch64-none-elf/4.8.3/include -Iinclude  -I../include -I../arch/arm/include -include ../include/linux/kconfig.h  -I../drivers/jtag -Idrivers/jtag -D__KERNEL__ -D__UBOOT__ -DCONFIG_SYS_TEXT_BASE=0x01000000 -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -g -fstack-usage -Wno-format-nonliteral -Werror -D__ARM__ -march=armv8-a -mstrict-align -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -fno-common -ffixed-x18 -pipe    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(jtag)"  -D"KBUILD_MODNAME=KBUILD_STR(jtag)" -c -o drivers/jtag/jtag.o ../drivers/jtag/jtag.c

source_drivers/jtag/jtag.o := ../drivers/jtag/jtag.c

deps_drivers/jtag/jtag.o := \
    $(wildcard include/config/aml/meson/axg.h) \
    $(wildcard include/config/aml/meson/g12a.h) \
    $(wildcard include/config/aml/meson/g12b.h) \
    $(wildcard include/config/aml/meson/tl1.h) \
    $(wildcard include/config/aml/meson/sm1.h) \
    $(wildcard include/config/aml/meson/tm2.h) \
    $(wildcard include/config/aml/meson/txhd.h) \
  ../include/common.h \
...
drivers/jtag/jtag.o: $(deps_drivers/jtag/jtag.o)
