cmd_drivers/mtd/nand/amlogic_mtd/m3_nand.o := aarch64-none-elf-gcc -Wp,-MD,drivers/mtd/nand/amlogic_mtd/.m3_nand.o.d  -nostdinc -isystem /opt/gcc-linaro-aarch64-none-elf-4.8-2013.11_linux/bin/../lib/gcc/aarch64-none-elf/4.8.3/include -Iinclude  -I../include -I../arch/arm/include -include ../include/linux/kconfig.h  -I../drivers/mtd/nand/amlogic_mtd -Idrivers/mtd/nand/amlogic_mtd -D__KERNEL__ -D__UBOOT__ -DCONFIG_SYS_TEXT_BASE=0x01000000 -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -g -fstack-usage -Wno-format-nonliteral -Werror -D__ARM__ -march=armv8-a -mstrict-align -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -fno-common -ffixed-x18 -pipe    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(m3_nand)"  -D"KBUILD_MODNAME=KBUILD_STR(m3_nand)" -c -o drivers/mtd/nand/amlogic_mtd/m3_nand.o ../drivers/mtd/nand/amlogic_mtd/m3_nand.c

source_drivers/mtd/nand/amlogic_mtd/m3_nand.o := ../drivers/mtd/nand/amlogic_mtd/m3_nand.c

deps_drivers/mtd/nand/amlogic_mtd/m3_nand.o := \
  ...
  ../drivers/mtd/nand/amlogic_mtd/aml_mtd.h \
    $(wildcard include/config/not/skip/bad/block.h) \
    $(wildcard include/config/nand/key/block/num.h) \
    $(wildcard include/config/keysize.h) \
    $(wildcard include/config/parameter/page.h) \
...
drivers/mtd/nand/amlogic_mtd/m3_nand.o: $(deps_drivers/mtd/nand/amlogic_mtd/m3_nand.o)
