cmd_drivers/display/minui/graphics_fbdev.o := aarch64-none-elf-gcc -Wp,-MD,drivers/display/minui/.graphics_fbdev.o.d  -nostdinc -isystem /opt/gcc-linaro-aarch64-none-elf-4.8-2013.11_linux/bin/../lib/gcc/aarch64-none-elf/4.8.3/include -Iinclude  -I../include -I../arch/arm/include -include ../include/linux/kconfig.h  -I../drivers/display/minui -Idrivers/display/minui -D__KERNEL__ -D__UBOOT__ -DCONFIG_SYS_TEXT_BASE=0x01000000 -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -g -fstack-usage -Wno-format-nonliteral -Werror -D__ARM__ -march=armv8-a -mstrict-align -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -fno-common -ffixed-x18 -pipe    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(graphics_fbdev)"  -D"KBUILD_MODNAME=KBUILD_STR(graphics_fbdev)" -c -o drivers/display/minui/graphics_fbdev.o ../drivers/display/minui/graphics_fbdev.c

source_drivers/display/minui/graphics_fbdev.o := ../drivers/display/minui/graphics_fbdev.c

deps_drivers/display/minui/graphics_fbdev.o := \
    $(wildcard include/config/osd/scale/enable.h) \
  ../drivers/display/minui/minui.h \
  ../include/common.h \
  ...
  ../drivers/display/minui/graphics.h \
  ../drivers/display/minui/minui_log.h \
  ../drivers/display/minui/../osd/osd_hw.h \
  ../drivers/display/minui/../osd/osd.h \
  ../include/amlogic/color.h \

drivers/display/minui/graphics_fbdev.o: $(deps_drivers/display/minui/graphics_fbdev.o)
